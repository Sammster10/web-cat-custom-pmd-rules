...
/**
 * Based on the official net.sourceforge.pmd.lang.java.rule.internal.TestFrameworksUtil, but adapted to work with our custom TestCase class.
 */
public final class TestFrameworksUtil {

    private static final String JUNIT3_CLASS_NAME = "student.TestCase";
